package com.TheCompleteJavaDevCourse.Challenge_BobsBurgers_2;
...
public class BaseBurger {
    ...
    public double costOfBurgerWithAdditions() {
        ...
        System.out.println(this.name = "The base price of your " + this.name + " with " + this.meat + " on " + this.breadType
                + " costs " + hamburgerPrice);
